...
void Assignment2::Update(float deltaTime)
{
    ...
    Input::IsMouseDown(0); // 0: left click, 1: right click
    //drawArrow = leftMouseButtonDown;

        bool clickBeganOverCircle =
        leftMouseButtonClick && Assignment2::MouseIsOverCircle(mousePosition, circlePosition, circleRadius);
...
bool Assignment2::MouseIsOverCircle(glm::vec2 mousePos, glm::vec2 circlePos, float circleRadius)
{
...
glm::vec2 Assignment2::TrajectoryPoint(float time, glm::vec2 currentPos, glm::vec2 currentVelocity, glm::vec2 currentAcceleration)
{
